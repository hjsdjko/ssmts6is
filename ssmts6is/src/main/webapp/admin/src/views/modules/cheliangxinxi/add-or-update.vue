<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="司机" prop="siji">
          <el-input v-model="ruleForm.siji" 
              placeholder="司机" clearable  :readonly="ro.siji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="司机" prop="siji">
              <el-input v-model="ruleForm.siji" 
                placeholder="司机" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.cheliangxiangqing" label="车辆详情" prop="cheliangxiangqing">
                    <span>{{ruleForm.cheliangxiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
